 ...
 * Связный список - это набор объектов класса ListElement<E>, а в LinkedList Java
 * это набор объектов класса Node<E>.
 * <p>
...
public class List<E> {
    ...
    private static class ListElement<E> {
        ListElement next; //ссыдка на следующий элемент списка.
        E data; //данные, которые храним в списке.
    }
}
